                    ...
                    <div v-else-if="childMode === 'edit'">
                      ...
                      <div class="q-pa-md" align="left">
                        ...
                        <div class="row q-mb-sm">
                          ...
                          <!-- ---------------- Main Image ---------------- -->
                          <div
                            class="col q-ml-md cursor-pointer" @click="invokeFilePicker"
                          >
                            <q-img
                              contain
                              class="project-img bg-black"
              ...
              <q-tab-panel name="logs">
                ...
                >
                  ...
                  <div v-else-if="childMode === 'edit'">
                    ...
                    <div class="q-pa-sm">
                      <q-btn
                        round icon="add" color="secondary"
  ...
  data () {
    return {
      ...
      projectList: {
        options: [],
        filter: [],
        projects: [], // this gets transferred to curData.projects
        toc: {}
      },
      extraSponsorInfo: {
        img: {}
      ...
      */
      ...
      if (this.submitMode === 'view') {
        ...
        if (this.mainImage.file) {
          this.curData.webpage.imgURL = `challenges/${this.curData.uuid}/main/${this.mainImage.file.name}`
        ...
        this.db.collection('challenges').doc(this.curData.uuid).set({
      ...
      Promise.all(promises)
        .then(res => {
          ...
          for (let objField in res[3].data()) {
            this.userEmailToObjMap[res[3].data()[objField].email] = res[3].data()[objField]
          }
          ...
          for (let objField in this.projectList.toc) {
            if (objField !== 'alias') {
              ...
              if (this.curData.projects.includes(data.uuid)) {
                ...
                this.curData.projects = this.curData.projects.filter(v =>
                  v !== data.uuid
                )
              }
            }
        ...
        .then(() => {
          let lastSponsor
          if (this.curData.sponsors.length > 0) {
            let lastEl = this.curData.sponsors.length - 1
            lastSponsor = this.curData.sponsors[lastEl]
          }
          ...
          this.curData.sponsors.forEach(sponsor => {
            ...
            if (this.compareSponsor(lastSponsor, sponsor)) {
              setTimeout(() => {
                this.loading = false
              }, 100)
            }
